...
[CustomEditor(typeof(SplineController2))]
public class SplineControllerInspector : Editor {
	public override void OnInspectorGUI() {
		SplineController2 controller = (SplineController2)target;										//Cast the target (from Unity) as a SplineController
		...
		controller.mode = (SplineController2.Mode)EditorGUILayout.EnumPopup("Mode:", controller.mode);
		switch(controller.mode) {
		case SplineController2.Mode.KEYBOARD:
			...
			break;
		case SplineController2.Mode.MOUSE:
